const report = {
  ...
  section_1: {
    header: "Introduction",
    description:
      "Main sustainability goals and values and key metrics you want to highlight",
    byline: "Our Mission",
  ...
  section_2: {
    ...
    byline: "Our Mission",
    body:
      "- Fast fashion: The industry faces the challenge of excessive production and consumption, leading to high levels of waste, resource depletion, and environmental pollution.\n" +
