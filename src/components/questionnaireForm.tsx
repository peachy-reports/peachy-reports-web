        ...
        <Container>
            <form onSubmit={handleSubmit}>
                <TextInput
                    ...
                    defaultValue={"GreenFuture Technologies"}
                ></TextInput>
                <TextInput
                    name="2"
                    question={"What does your company make?"}
                    defaultValue={"Solar panels and energy-efficient smart home devices"}
                ></TextInput>
                <TextInput
                    name="3"
...
function TextInput({name, question, defaultValue = ""}: questionProps) {
...
function TextareaInput({name, question, defaultValue=""}: questionProps) {
    const [value, setValue] = useState(defaultValue);
    const handleChange = (event: any) => setValue(event.target.value);
