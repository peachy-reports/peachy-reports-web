              ...
              <VStack spacing={10}>
                  <Box bg='seashell' minHeight='80px' padding={box.padding}>
                      <Container maxW='container.lg'>
                          <strong>{report.section_1.header}</strong>: {report.section_1.body}
                      </Container>
                  </Box>
                  <Box bg='#F4E9E6' minHeight='80px' padding={box.padding}>
                      <Container maxW='container.lg'>
                          <strong>{report.section_2.header}</strong>: {report.section_2.body}
                      </Container>
                  </Box>
              </VStack>
              <VStack spacing={10}>
                  <Box bg='#6FB7BF' minHeight='80px' minWidth='100%' padding={box.padding}>
                      <Container maxW='container.lg' >
                          <strong>{report.section_3.header}</strong>: {report.section_3.description}
                  ...
                  <Box bg='#9AD2D8' minHeight='80px' minWidth='100%' padding={box.padding}>
                      <Container maxW='container.lg'>
                          <strong>{report.section_4.header}</strong>: {report.section_4.description}
                          <p style={{textAlign:"center"}}><strong style={{fontSize:"3em"}}>{report.section_4.body}</strong></p>
                      </Container>
                  </Box>
                  <Box bg='#6FB7BF' minHeight='80px' minWidth='100%' padding={box.padding}>
                      <Container maxW='container.lg'>
                          <strong>{report.section_5.header}</strong>: {report.section_5.description}
